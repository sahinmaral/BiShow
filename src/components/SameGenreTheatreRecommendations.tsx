...
> = ({ genreName }) => {
  ...
  return (
    <div className="flex flex-col">
      <h1 className="text-xl font-bold mb-5">Benzer Etkinlikler</h1>
          ...
          {theatresThatSameGenre.map((theatre) => {
            return (
              ...
              >
                ...
                <h3 className="font-bold text-center group-hover:text-purple-heart-500 group-hover:drop-shadow-lg">{theatre.name}</h3>
              </Link>
            );
          })}
        </div>
